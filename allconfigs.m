...
allconn_set = {...
    ...
    {... %%%% ARCHITECTURE 34
    {'kme1layer',   'kme',{'pos'},{{'ms'},{}},                    'pos',[1 0],parsk(1),'knn',parsc(1),'nodes',useroptions.k}...
    {'knn2layer',   'knn',{'kme1layer'},{{'rds',0},{}},             'pos',[useroptions.w 0],parsk(2),'svm',parsc(2),'indexes',useroptions.k}...
    }...
    {... %%%% ARCHITECTURE 35
    {'kme1layer',   'kme',{'pos'},{{'ms'},{}},                    'pos',[1 0],parsk(1),'knn',parsc(1),'nodes',useroptions.k}...
    {'knn2layer',   'knn',{'kme1layer'},{{'rds',useroptions.cw},{'rds',useroptions.cw}},             'pos',[useroptions.w 0],parsk(2),'svm',parsc(2),'indexes',useroptions.k}...
    }...
    {... %%%% ARCHITECTURE 36
    {'kme1layer',   'kme',{'pos'},{{'ms'},{}},                    'pos',[useroptions.w 0],parsk(1),'knn',parsc(1),'nodes',useroptions.k}...    
    }...
    {... %%%% ARCHITECTURE 37
    {'kme1layer',   'kme',{'pos'},{{'msu'},{}},                    'pos',[useroptions.w 0],parsk(1),'knn',parsc(1),'nodes',useroptions.k}...    
    }...
    {... %%%% ARCHITECTURE 38
    {'lu1l',        'kme',{'pos'},                              {{'ms','lu'},{'lu'}},                                        'pos',[useroptions.w 0],parsk(1),'knn',parsc(1),'nodes',useroptions.k}...    
    {'ll1l',        'kme',{'pos'},                              {{'ms','ll'},{'ll'}},                                        'pos',[useroptions.w 0],parsk(1),'knn',parsc(1),'nodes',useroptions.k}...    
    {'to1l',        'kme',{'pos'},                              {{'ms','to'},{'to'}},                                        'pos',[useroptions.w 0],parsk(1),'knn',parsc(1),'nodes',useroptions.k}...    
    {'ru1l',        'kme',{'pos'},                              {{'ms','ru'},{'ru'}},                                        'pos',[useroptions.w 0],parsk(1),'knn',parsc(1),'nodes',useroptions.k}...    
    {'rl1l',        'kme',{'pos'},                              {{'ms','rl'},{'rl'}},                                        'pos',[useroptions.w 0],parsk(1),'knn',parsc(1),'nodes',useroptions.k}...    
    {'knn2layer',   'knn',{'lu1l','ll1l','to1l','ru1l','rl1l'}, {{{'rds',useroptions.cw}},{{'rds',useroptions.cw}}},             'pos',[useroptions.w 0],parsk(2),'svm',parsc(2),'indexes',useroptions.k}...
    }...
    {... %%%% ARCHITECTURE 39
    {'lu1l',        'kme',{'pos'},                              {{'ms','lu'},{'lu'}},  'pos',[useroptions.w 0],parsk(1),'knn',parsc(1),'nodes',useroptions.k}...    
    {'ll1l',        'kme',{'pos'},                              {{'ms','ll'},{'ll'}},  'pos',[useroptions.w 0],parsk(1),'knn',parsc(1),'nodes',useroptions.k}...    
    ...
    {'ru1l',        'kme',{'pos'},                              {{'ms','ru'},{'ru'}},  'pos',[useroptions.w 0],parsk(1),'knn',parsc(1),'nodes',useroptions.k}...    
    {'rl1l',        'kme',{'pos'},                              {{'ms','rl'},{'rl'}},  'pos',[useroptions.w 0],parsk(1),'knn',parsc(1),'nodes',useroptions.k}...    
    {'knn2layer',   'knn',{'lu1l','ll1l','to1l','ru1l','rl1l'}, {{},{}},               'pos',[useroptions.w 0],parsk(2),'svm',parsc(2),'indexes',useroptions.k}...
    }...
    {... %%%% ARCHITECTURE 40
    {'lu1l',        'kme',{'pos'},                              {{'ms','lu'},{'lu'}},  'pos',[useroptions.w 0],parsk(1),'knn',parsc(1),'nodes',useroptions.k}...    
    {'ll1l',        'kme',{'pos'},                              {{'ms','ll'},{'ll'}},  'pos',[useroptions.w 0],parsk(1),'knn',parsc(1),'nodes',useroptions.k}...    
